<?php
	...
	$q = "update prijava set Status='Odobreno' where ID_prijava=$id";
	...
	if (mysql_query($q)) {
		...
		//log
			...
			$vrijeme= date("H:i:s");
			$k= $_SESSION['Korisnik'];
			$log="insert into dnevnik (ID_dnevnik,Korisnicko_ime, Datum, Vrijeme, Komentar)values (default, '$k', '$datum', '$vrijeme', 'Administrator je odobrio prijavu.')";
		...
		$message = 'Poštovani '.$podaci[4].' '.$podaci[5].', vaša prijava je odobrena.';
